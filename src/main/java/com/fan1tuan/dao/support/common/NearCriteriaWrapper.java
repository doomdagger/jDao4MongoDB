...
public class NearCriteriaWrapper {
    ...
    /**
     * return spherical values for the actual distance
     * @param spherical boolean, yes or no
     * @return geo criteria
     */
    public NearCriteriaWrapper spherical(boolean spherical){
        nearQuery.spherical(spherical);
        return this;
    }
