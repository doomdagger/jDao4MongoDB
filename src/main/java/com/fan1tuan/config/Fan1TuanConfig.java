...
/**
 * for configuration. load properties from file -- fan1tuan.properties
 * static one
 * @author Li He
 *
 */
...
public class Fan1TuanConfig {
    ...
    private final static String default_config = "/com/fan1tuan/config/fan1tuan.properties";
    private final static String custom_config = "/fan1tuan-custom.properties";
    ...
    static {
        ...
        try {
            ...
            Class configClass = Class.forName("com.fan1tuan.config.Fan1TuanConfig");
...
//        		System.err.println(key);
    ...
    public static long getLongProperty(String name){
        return Fan1TuanConfig.getLongProperty(name,0L);
    }
    ...
    public static double getDoubleProperty(String name) {
        return Fan1TuanConfig.getDoubleProperty(name,0.0);
    }
